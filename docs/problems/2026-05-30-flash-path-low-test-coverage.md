...
4. **Severity:** S4 (Minor)
5. **Location:** `apps/cli/src/easymanet_cli/flash.py` (~17%), `packages/core/src/easymanet/disks/macos.py` (~12%), `packages/core/src/easymanet/format.py` (~12%); compare `packages/core/src/easymanet/validate.py` (~89%), `packages/core/src/easymanet/image.py` (~75%)
